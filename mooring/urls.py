...
api_patterns = [
    ...
    url(r'^api/reports/booking-mooring-created$', api.BookingCreatedReportView.as_view(),name='bookings-created-report'),
    url(r'^api/reports/booking-mooring-departure$', api.BookingDepartureReportView.as_view(),name='booking-mooring-departure'),
    url(r'^api/reports/booking-admission-created$', api.AdmissionBookingCreatedReportView.as_view(),name='booking-admission-created'),
...
urlpatterns = [
    ...
    url(r'^dashboard/annual-bookingperiods-option/(?P<bp_group_id>[0-9]+)/delete/(?P<pk>[0-9]+)', views.AnnualBookingPeriodDeleteOption.as_view(), name='dash-annual-booking-period-option-delete'),
    ...
    url(r'^dashboard/annual-bookingperiods/(?P<pk>[0-9]+)/delete', views.AnnualBookingPeriodDeleteGroup.as_view(), name='dash-annual-bookingperiod-group-delete'),
