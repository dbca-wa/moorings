...
<!-- here -->
		...
		<div class="alert alert-warning" style='text-align: center' v-show='annualadmissionslink == true' role="alert" v-if="admissions_key" id="admissions_link"> <strong style='font-size: 16px;' ></span><a :href='"/annual-admissions/" + admissions_key + "/"'>Click here for paying annual admission fees only</a></strong><br></div>   
